...
1 :Generated by 'django-admin startproject' using Django 3.0.7.
...
INSTALLED_APPS = [
    ...
    # 2 :We create our own app with this command :(python manage.py startapp appname) in terminal
    #    Add my app to the installed app 
    'weather_api'
]
